...
val test1d = is_older(march31_2011, june1_2013) = false;
...
val test2c = number_in_month([feb28_2012,dec1_2013,march31_2011,april28_2011,june1_2013],4) = 1

val test3a = number_in_months([feb28_2012,dec1_2013,march31_2011,april28_2011],[2,3,4]) = 3
val test3b = number_in_months([feb28_2012,dec1_2013,march31_2011,april28_2011,june1_2013],[2,3,4,6]) = 4
...
val test4c = dates_in_month([feb28_2012,march31_2011,june1_2013,dec1_2013],3) = [march31_2011]
...
val test5e = dates_in_months([feb28_2012,june1_2013,march31_2011],[3,6]) = [march31_2011,june1_2013]
...
val test6d = get_nth(["Linux", "Ubuntu", "Max OS X", "Yosemite", "Windows", "8"], 1) = "Linux"
...
val test10f = month_range(18+23, 15+19+22) = [2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2]
...
val test11c = oldest([april28_2011,march31_2011,dec1_2013,june1_2013]) = SOME dec1_2013
...
val test12e = reasonable_date({year = 2015, month = 1, day = 26});
(**)
